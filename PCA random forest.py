# -*- coding: utf-8 -*-
"""
Created on Fri Apr 12 15:24:55 2024
...
from sklearn.metrics import classification_report, confusion_matrix, plot_confusion_matrix, roc_curve, precision_recall_curve, auc, average_precision_score, make_scorer, f1_score
...
param_grid = {
    'n_estimators': [100],
    'criterion': ['gini'],# Example hyperparameters for RandomForestClassifier
    'max_depth': [20],
