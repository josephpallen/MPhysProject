# -*- coding: utf-8 -*-
"""
Created on Sat Apr 13 20:36:26 2024
...
for i in range(10):
    mlpc_clf = MLPClassifier(activation = 'tanh', alpha = 0.01, hidden_layer_sizes = (42,), learning_rate = 'constant', solver = 'lbfgs', max_iter=100000)
    mlpc_clf.fit(X_train_scaled, y_train) # Ensure the model is trained

    # Predict on the test dataset
    predictions = mlpc_clf.predict(X_test_scaled)
...
test_df.to_csv('mlpclassifier candidates.csv', index=False)
